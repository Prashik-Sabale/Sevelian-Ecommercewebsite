...
const ProductDetailTShirt = () => {
    ...
    useEffect(() => {
        const findDetail = items.filter(product => product.slug === slug);
                        ...
                        <div class="grid gap-8 md:grid-cols-2">
                            ...
                            <div class="md:py-8">
                                ...
                                <div class="mb-6 flex items-center md:mb-10">
                                    ...
                                    <a href="#" class="ml-4 text-sm font-semibold text-black transition duration-100 hover:text-slate-900 ">view all 47 reviews</a>
                                </div>
...
export default ProductDetailTShirt