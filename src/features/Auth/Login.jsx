...
function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error("Something went wrong on our end. ServerError")
        }
                    ...
                    <div class="w-full">
                        ...
                        <div class="mt-5">
                            <form action="" onSubmit={handleSubmit}>
                                ...
                                <div class="relative mt-6">
                                    <input type="password" name="password" id="password" placeholder="Password" class="peer peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" value={password} onChange={setPassword} />
